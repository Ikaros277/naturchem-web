...
| Betriebsregeln | Ermöglicht die Überprüfung, ob die Messung der zulässigen Betriebsart | entspricht
...
1. Finden Sie die aktuelle Betriebserlaubnis oder den aktuellen behördlichen Beschluss.
2. Überprüfen Sie, welche Quelle und welche Abgase bewertet werden sollen.
3. Prüfen Sie, ob Emissionsgrenzwerte und Messintervalle in der Genehmigung angegeben sind.
4. Bereiten Sie Gerätedatenblätter, Technologiebeschreibungen und Betriebsaufzeichnungen vor.
5. Prüfen Sie, ob am Auspuff ein geeigneter und sicherer Messort vorhanden ist.
6. Wenn die Autoritätsanforderung unklar ist, lassen Sie sie von einem Experten beurteilen, bevor Sie eine Messung anordnen.
