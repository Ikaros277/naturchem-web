---
title: "Emission factors and emission calculation: when calculation is enough and when measurement is required"
...
1. Check the current operating permit and find out whether emission measurement is required for the source.
2. Clarify the purpose of the document: SPE, fees, dispersion study, permit change, internal estimate, or limit verification.
3. Prepare fuel, raw material, and solvent consumption, operating hours, and technical data sheets of substances used.
4. Check whether a suitable emission factor, balance, or other acceptable calculation method exists.
5. Verify units, reference variables, filtration efficiency, and link to actual operation.
6. Assess whether calculation suffices for the given purpose or whether authorised emission measurement is necessary.
...
|---|---|
| [Act No. 201/2012 Coll., on air protection](https://www.zakonyprolidi.cz/cs/2012-201) | sets basic rules for determining pollution level by measurement or calculation |
| [Section 6 of Act No. 201/2012 Coll.](https://www.zakonyprolidi.cz/cs/2012-201#p6) | regulates determination and evaluation of pollution level, one-off measurement, continuous measurement, and calculations |
| [Decree No. 415/2012 Coll.](https://www.zakonyprolidi.cz/cs/2012-415) | sets details on permissible pollution level and methods of its determination |
| [Ministry of the Environment notice on emission factors](https://mzp.gov.cz/system/files/2025-12/OOO-Sdeleni_emisni_faktory-20251217.pdf) | sets emission factors under Decree No. 415/2012 Coll. and describes the basic calculation method |
| [Ministry of the Environment – industry and energy in air protection](https://mzp.gov.cz/cz/agenda/ochrana-ovzdusi/zdroje-znecistovani-ovzdusi/prumysl-a-energetika) | contains methodological information, news, and links on obligations of source operators |
| [ISPOP – air agenda](https://www.ispop.cz/prehled-ohlasovacich-povinnosti/agenda-ovzdusi/) | overview of notification obligations, forms, and deadlines for the air area |
...
- [Ministry of the Environment notice on emission factors](https://mzp.gov.cz/system/files/2025-12/OOO-Sdeleni_emisni_faktory-20251217.pdf)
