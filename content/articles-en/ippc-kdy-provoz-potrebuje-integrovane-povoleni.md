---
title: 'IPPC: when does an operation need an integrated permit'
...
IPPC stands for integrated pollution prevention and control. In Czech law this is mainly the regime under [Act No. 76/2002 Coll., on integrated prevention](https://www.zakonyprolidi.cz/cs/2002-76).
...
1. Does any main activity fall under Annex No. 1?
2. Does designed or production capacity exceed the relevant threshold value?
3. Are there related activities on the site that should be included in the installation?
...
More on environmental services can be found on the [NATURCHEM Services page](https://www.naturchem.cz/en/sluzby).
...
|---|---|
| [Act No. 76/2002 Coll., on integrated prevention](https://www.zakonyprolidi.cz/cs/2002-76) | Basic legal instrument for IPPC. Defines the purpose of the Act, operator obligations, proceedings on issue of an integrated permit, changes to permits, inspection and sanctions. |
...
| [IPPC Information System](https://ippc.mzp.cz/) | Public system where current proceedings, issued integrated permits, information on installations and methodological materials can be found. |
| [Act No. 100/2001 Coll., EIA](https://www.zakonyprolidi.cz/cs/2001-100) | Important for new projects or significant changes. EIA and IPPC are separate processes, but in practice they are often closely related. |
