---
title: 'Dust control measures on construction sites: what documentation should contain and what the authority may require'
...
|---|---|
| [Act No. 201/2012 Coll., on air protection](https://www.zakonyprolidi.cz/cs/2012-201) | Basic legal framework for air protection. For structures the principle of preventing air pollution and the obligation to limit pollution where it may arise are especially important. |
| [Act No. 100/2001 Coll., on environmental impact assessment (EIA)](https://www.zakonyprolidi.cz/cs/2001-100) | For larger projects dust from construction activity is addressed in EIA documentation, notification, opinion conditions, or subsequent procedures. |
| [Act No. 148/2023 Coll., on the unified environmental opinion (JES)](https://www.zakonyprolidi.cz/cs/2023-148) | JES can integrate environmental requirements of affected bodies. For structures it may be important whether documentation sufficiently describes impacts on air and proposed measures. |
| [MŽP methodological guideline on limiting dust from construction activity](https://mzp.gov.cz/system/files/2024-11/OOO-MP_omezovani_prasnosti_ze_stavebni_cinnosti-20190918.pdf) | Practical methodological basis for designing measures against dust in all construction phases, from project preparation to implementation. |
| [Methodology for determining measures to reduce impacts of construction activity on immission load from PM10 particles](https://mzp.gov.cz/system/files/2024-11/OOO-MP_stavebni_cinnost_opatreni-20200601.pdf) | More detailed expert basis for designing technical and organisational measures, especially for structures with more significant dust generation. |
