...
**Poznámka k P5-14–16 (mobilní fold, 2026-05-31):** Na desktopu zůstává Hero → Trust → Stats. Na mobilu (`<1024px`, scope `.home-page`) se trust band skrývá, stats jsou 3 kompaktní karty vedle sebe. **P5-21:** vrstvené copy H1 + lead. **Od 31. 5.:** stejný hero text na mobilu i desktopu — responzivita jen CSS (P5-22 pravidla).
...
| P5-17 | Mobilní fold follow-up: snížit padding po zkrácení hero copy | `globals.css` | Nízká | Po P5-21 |
