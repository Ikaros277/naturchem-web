...
**Poznámka k P5-14–16 (mobilní fold, 2026-05-31):** Na desktopu zůstává Hero → Trust → Stats. Na mobilu (`<1024px`, scope `.home-page`) se trust band skrývá, stats jsou 3 kompaktní karty vedle sebe. **P5-21:** vrstvené copy H1 + lead. **P5-17:** padding hero/stats/offer snížen po zkrácení copy. **Od 31. 5.:** stejný hero text na mobilu i desktopu — responzivita jen CSS (P5-22 pravidla).
...
| P5-17 | Mobilní fold follow-up: snížit padding po zkrácení hero copy | `globals.css` | Nízká | ✅ 31. 5. — hero 1.15/0.85rem, stats 0.5rem, offer gap 0.9rem |
| P5-18 | Homepage offer karty: nadpis vedle ikony (card-head) | `app/page.tsx`, `globals.css` | Nízká | — |
| P5-21 | Homepage hero: vrstvené copy — H1 max 8 slov, lead bez zdvojení H1 | `app/page.tsx` | Nízká | ✅ 31. 5. |
| P5-22 | Hero pravidla (vrstvy, mobil, CTA dle typu stránky) | `04-ai-role/ux-role.md`, `copy-role.md` | Nízká | ✅ 31. 5. |
| P5-23 | Redesign patičky: jeden responsive grid, 4 zóny (brand / služby / společnost / kontakt), akreditace jako odkaz místo PDF seznamu | `components/Footer.tsx`, `lib/footer-nav.ts`, `globals.css` | Střední | ✅ 31. 5. |
