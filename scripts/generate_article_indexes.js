...
const { readArticleContentVersion } = require("./lib/article-content-version.js");
...
function main() {
  ...
  if (only === "all") {
    const version = readArticleContentVersion(path.join(root, "content"));
    fs.writeFileSync(path.join(root, "src/lib/article-content-version.ts"),
      `// Generated by scripts/generate_article_indexes.js. Do not edit manually.\nexport const articleContentVersion = "${version}";\n`);
  }
