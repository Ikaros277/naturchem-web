...
export const equipmentGroups: readonly EquipmentGroup[] = [
  {
    ...
    items: [
      ...
      "Pitot tubes and pressure differential transducers Delta Ohm / Senseca",
  ...
  },
  {
    ...
    items: [
      "multifunction measurement systems Delta Ohm / Senseca DO9847",
      "temperature, humidity and pressure sensors Delta Ohm / Senseca",
